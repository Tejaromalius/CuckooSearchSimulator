...
export class Sphere extends Landscape {
  ...
  get bounds() { return 10; }
  get hScale() { return 0.1; }
  get visOffset() { return 0; }
  get colors() { return [0x000000, 0x00ff00]; } // Black to Green
  get analogy() { return "A simple bowl. Any decent algorithm should roll straight to the bottom. Used as a baseline sanity check."; }
